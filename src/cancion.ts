...
document.querySelector<HTMLDivElement>('#ejercicioTres')!.innerHTML = `
<nav>
  <div class="nav-wrapper green darken-3">
    <ul id="nav-mobile" class="left hide-on-med-and-down">
      ...
      <li class="active"><a href="../ejercicio_tres/index.html">Ejercicio 3</a></li>
...
<h1 class="orange-text">Hola mundillo1!</h1>
`