...
document.querySelector<HTMLDivElement>('#ejercicioCinco')!.innerHTML = `
<nav>
  <div class="nav-wrapper green darken-3">
    <ul id="nav-mobile" class="left hide-on-med-and-down">
      ...
      <li class="active"><a href="../ejercicio_cinco/index.html">Ejercicio 5</a></li>
    </ul>
  </div>
</nav>

<h1 class="purple-text">Hola mundillo1!</h1>
`